...
{
    [System.Serializable] public struct AudioSet
    {
        public string Name;
    ...
    public void SpawnSound(string setName, float volume, Vector3 position, float pitchDefault = 1, float pitchRange = 0)
    {
        ...
        pooledSource.Play();
        pooledSource.GetComponent<OnReturnToPool>().Invoke("Return", pooledSource.clip.length + 1.0f);
    }
    /// <summary>
